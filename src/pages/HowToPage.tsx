...
/** Inline diamond-rule divider — echoes the .er-rule codex motif.
 *  Mirrors DiamondRule.tsx (src/components/ui/DiamondRule.tsx) for pages
 *  that don't yet import the shared component. */
  ...
  return (
    <div className="flex h-screen flex-col">
      ...
      <main className="mx-auto w-full max-w-3xl flex-1 overflow-y-auto px-6 py-8">
        ...
        {/* ── Page title ── */}
        <div className="er-reveal mb-2">
          <h1 className="font-display text-3xl text-gold">How to use</h1>
        </div>
        <p className="er-reveal mb-2 text-sm text-ink-dim" style={{ animationDelay: '0.06s' }}>
          A quick orientation to the guide, the map, and progress tracking.
        </p>
        <DiamondRule className="my-6" />

        {/* ── Table of contents ── */}
        <nav aria-label="Page contents" className="er-reveal er-card mb-8 px-5 py-4" style={{ animationDelay: '0.12s' }}>
          <p className="er-eyebrow mb-3">Contents</p>
          <ol className="space-y-1.5">
            {TOC.map((item, i) => (
              <li key={item.id} className="flex items-baseline gap-2">
                <span className="er-num text-xs text-gold-dim tabular-nums">{String(i + 1).padStart(2, '0')}</span>
                <a
                  href={`#${item.id}`}
                  className="er-link text-sm text-ink hover:text-gold"
                >
                  {item.label}
                </a>
              </li>
        ...
        <div className="er-stagger space-y-0">

          {/* § 1 — What this is */}
          <section id="what-this-is" className="mb-8 scroll-mt-6">
            <p className="er-eyebrow mb-1">Section I</p>
            <h2 className="font-display mb-4 text-xl text-gold">What this is</h2>
          ...
          {/* § 2 — Reading the route */}
          <section id="reading-the-route" className="mb-8 scroll-mt-6">
            <p className="er-eyebrow mb-1">Section II</p>
            <h2 className="font-display mb-4 text-xl text-gold">Reading the route</h2>
            <div className="space-y-3 leading-relaxed text-ink">
              <p>The route has three levels of structure:</p>
              <ul className="ml-4 list-disc space-y-1.5 text-ink-dim">
                <li>
          ...
          {/* § 3 — Using the map */}
          <section id="using-the-map" className="mb-8 scroll-mt-6">
            <p className="er-eyebrow mb-1">Section III</p>
            <h2 className="font-display mb-4 text-xl text-gold">Using the map</h2>
            <div className="space-y-3 leading-relaxed text-ink">
              <p>
          ...
          {/* § 4 — Tracking progress */}
          <section id="tracking-progress" className="mb-8 scroll-mt-6">
            <p className="er-eyebrow mb-1">Section IV</p>
            <h2 className="font-display mb-4 text-xl text-gold">Tracking progress</h2>
            <div className="space-y-4 leading-relaxed text-ink">
              <p>
                Progress is saved locally in your browser (<code className="rounded bg-panel px-1 text-gold-dim">localStorage</code>).
                Nothing is sent anywhere by default — no account, no server, no tracking.
              </p>

              <div>
                <h3 className="font-display mb-2 text-base text-gold-dim">NG+ profiles</h3>
                <p>
              ...
              <div>
                <h3 className="font-display mb-2 text-base text-gold-dim">Export &amp; import</h3>
                <p>
              ...
              <div>
                <h3 className="font-display mb-2 text-base text-gold-dim">Sync code (moving between devices)</h3>
                <p>
                ...
                <p className="mt-2 text-xs text-ink-dim">
                  ...
                  <code className="rounded bg-panel px-1">?code=&lt;your-code&gt;</code> to the Progress page URL. The receiving device
          ...
          {/* § 5 — Build optimizer */}
          <section id="build-optimizer" className="mb-8 scroll-mt-6">
            <p className="er-eyebrow mb-1">Section V</p>
            <h2 className="font-display mb-4 text-xl text-gold">Build optimizer</h2>
            <div className="space-y-3 leading-relaxed text-ink">
              <p>
          ...
          <section id="coverage-contributing" className="mb-8 scroll-mt-6">
            <p className="er-eyebrow mb-1">Section VI</p>
            <h2 className="font-display mb-4 text-xl text-gold">Coverage &amp; contributing</h2>
            <div className="space-y-3 leading-relaxed text-ink">
              <p>
              ...
              <p>
                ...
                <code className="rounded bg-panel px-1 text-gold-dim">data/regions/</code>, run{' '}
                <code className="rounded bg-panel px-1 text-gold-dim">npm run validate</code> to confirm the schema and
