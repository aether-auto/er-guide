...
export interface Weapon {
  ...
  weaponName: string
  /** A (rarely-used) modifier to differentiate variants beyond what's shown in-game */
  variant?: string
  /** A wiki link for the weapon */
  url: string | null
  /** The affinity of the weapon for filtering */
  affinityId: number
  /** The category of the weapon for filtering */
  weaponType: WeaponType
  /** Player attribute requirements to use the weapon without an attack-rating penalty */
  ...
  /** Map indicating which scaling curve is used for each damage type / status / spell scaling */
  ...
  /** Thresholds and labels for each scaling grade (S, A, B, etc.) for this weapon */
