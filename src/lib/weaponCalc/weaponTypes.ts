...
/** Weapon types that aren't real attacking weapons — excluded from rankings. */
export const nonWeaponTypes: WeaponType[] = [
...
/** Catalyst weapon types (staves / seals) — ranked via spell scaling, not AR. */
export const catalystTypes: WeaponType[] = [
