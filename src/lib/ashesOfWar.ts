...
// damage type). 98 skills, 59 with motion values.
//
...
export const ashesOfWar: AshOfWar[] = [
  { skill: 'Aspects of the Crucible: Wings', category: 'Melee/Burst', dealsDamage: true, scaling: 'weapon-ar', element: 'physical', fp: '22', transferable: true, dlc: true, motionValue: 258, note: 'Sacred affinity; piercing thrust or spin (twinblades); DLC' },
  ...
  { skill: 'Barrage', category: 'Projectile', dealsDamage: true, scaling: 'weapon-ar', element: 'physical', fp: '0/2/2', transferable: false, dlc: false, motionValue: 80, affinity: 'Standard', itemName: 'Ash of War: Barrage', note: 'Rapid consecutive bow shots; bows only' },
  ...
  { skill: 'Beast\'s Roar', category: 'AoE', dealsDamage: true, scaling: 'flat', element: 'physical', fp: '10', transferable: true, dlc: false, affinity: 'Keen', itemName: 'Ash of War: Beast\'s Roar', note: 'AoE shockwave blast; no added element' },
  ...
  { skill: 'Blinkbolt', category: 'Dash/Evasion', dealsDamage: true, scaling: 'flat', element: 'lightning', fp: '8', transferable: true, dlc: true, note: 'Lightning teleport dash; minimal dmg; i-frames; all melee; DLC' },
  ...
  { skill: 'Blood Tax', category: 'Melee/Burst', dealsDamage: true, scaling: 'weapon-ar', element: 'physical', fp: '14', transferable: true, dlc: false, motionValue: 88, status: 'blood', affinity: 'Blood', itemName: 'Ash of War: Blood Tax', note: 'Multi-hit grab lifesteal; bleed buildup' },
  ...
  { skill: 'Bloody Slash', category: 'Melee/Burst', dealsDamage: true, scaling: 'flat', element: 'physical', fp: '6', transferable: true, dlc: false, status: 'blood', affinity: 'Blood', itemName: 'Ash of War: Bloody Slash', note: 'Downward slash+wave; self-chip 11% HP; bleed buildup' },
  ...
  { skill: 'Dryleaf Whirlwind', category: 'AoE', dealsDamage: true, scaling: 'weapon-ar', element: 'physical', fp: '9', transferable: true, dlc: true, motionValue: 120, note: 'Spinning fist AoE; hand-to-hand; DLC' },
  { skill: 'Earthshaker', category: 'AoE', dealsDamage: true, scaling: 'weapon-ar', element: 'physical', fp: '10/5', transferable: false, dlc: false, motionValue: 100, affinity: 'Heavy', itemName: 'Ash of War: Earthshaker', note: 'Ground slam shockwave; hammers/colossal' },
  ...
  { skill: 'Eruption', category: 'AoE', dealsDamage: true, scaling: 'weapon-ar', element: 'fire', fp: '14', transferable: true, dlc: false, motionValue: 90, affinity: 'Fire', itemName: 'Ash of War: Eruption', note: 'Upward slam + fire geyser AoE' },
  { skill: 'Flame Skewer', category: 'Melee/Burst', dealsDamage: true, scaling: 'weapon-ar', element: 'fire', fp: '18/8', transferable: true, dlc: true, motionValue: 138, note: 'Chargeable fire thrusting attack; DLC' },
  { skill: 'Flame Spear', category: 'Projectile', dealsDamage: true, scaling: 'weapon-ar', element: 'fire', fp: '19', transferable: true, dlc: true, motionValue: 80, note: 'Chargeable fire spear thrust/projectile; DLC' },
  { skill: 'Flame of the Redmanes', category: 'AoE', dealsDamage: true, scaling: 'flat', element: 'fire', fp: '14', transferable: true, dlc: false, affinity: 'Fire', itemName: 'Ash of War: Flame of the Redmanes', note: 'Ground fire wave; excellent poise damage' },
  ...
  { skill: 'Ground Slam', category: 'AoE', dealsDamage: true, scaling: 'flat', element: 'physical', fp: '14', transferable: true, dlc: false, affinity: 'Heavy', itemName: 'Ash of War: Ground Slam', note: 'Hammer ground slam + outer shockwave ~132' },
  ...
  { skill: 'Ice Spear', category: 'Projectile', dealsDamage: true, scaling: 'flat', element: 'physical', fp: '15', transferable: false, dlc: false, status: 'frost', affinity: 'Cold', itemName: 'Ash of War: Ice Spear', note: 'Frost-coated spear; frost buildup on hit' },
  { skill: 'Igon\'s Drake Hunt', category: 'Projectile', dealsDamage: true, scaling: 'weapon-ar', element: 'physical', fp: '0', transferable: true, dlc: true, motionValue: 155, note: 'Anti-dragon ranged; DLC' },
  ...
  { skill: 'Kick', category: 'Melee/Burst', dealsDamage: true, scaling: 'flat', element: 'physical', fp: '0', transferable: true, dlc: false, affinity: 'Heavy', itemName: 'Ash of War: Kick', note: 'Basic kick; low dmg; staggers; 0 FP' },
  { skill: 'Lifesteal Fist', category: 'Melee/Burst', dealsDamage: true, scaling: 'weapon-ar', element: 'physical', fp: '14', transferable: false, dlc: false, motionValue: 73, affinity: 'Occult', itemName: 'Ash of War: Lifesteal Fist', note: 'Grab attack; drains HP from enemy' },
  { skill: 'Lightning Ram', category: 'Charge', dealsDamage: true, scaling: 'flat', element: 'lightning', fp: '5/5', transferable: true, dlc: false, affinity: 'Lightning', itemName: 'Ash of War: Lightning Ram', note: 'Lightning-charged rolling body slam; lightning element' },
  ...
  { skill: 'Mighty Shot', category: 'Projectile', dealsDamage: true, scaling: 'weapon-ar', element: 'physical', fp: '0/6/6', transferable: false, dlc: false, motionValue: 153, affinity: 'Standard', itemName: 'Ash of War: Mighty Shot', note: 'Charged heavy bow shot; bows only' },
  ...
  { skill: 'Palm Blast', category: 'Melee/Burst', dealsDamage: true, scaling: 'weapon-ar', element: 'physical', fp: '14', transferable: true, dlc: true, motionValue: 220, note: 'Chargeable point-blank palm strike; DLC' },
  { skill: 'Phantom Slash', category: 'Melee/Burst', dealsDamage: true, scaling: 'weapon-ar', element: 'physical', fp: '8/8', transferable: false, dlc: false, motionValue: 132, affinity: 'Quality', itemName: 'Ash of War: Phantom Slash', note: 'Teleport + combo slashes' },
  ...
  { skill: 'Raging Beast', category: 'Melee/Burst', dealsDamage: true, scaling: 'weapon-ar', element: 'physical', fp: '7/7', transferable: true, dlc: true, motionValue: 145, note: 'Beast rush + claw combo; DLC' },
  ...
  { skill: 'Repeating Thrust', category: 'Melee/Burst', dealsDamage: true, scaling: 'weapon-ar', element: 'physical', fp: '7', transferable: true, dlc: false, motionValue: 99, affinity: 'Keen', itemName: 'Ash of War: Repeating Thrust', note: 'Rapid repeated thrusts; chainable' },
  ...
  { skill: 'Savage Claws', category: 'Melee/Burst', dealsDamage: true, scaling: 'weapon-ar', element: 'physical', fp: '13', transferable: true, dlc: true, motionValue: 80, note: 'Claw swipe combo; DLC' },
  ...
  { skill: 'Shriek of Sorrow', category: 'AoE', dealsDamage: true, scaling: 'flat', element: 'physical', fp: '19', transferable: true, dlc: true, note: 'Shockwave scream burst; DLC' },
  { skill: 'Spectral Lance', category: 'Projectile', dealsDamage: true, scaling: 'flat', element: 'physical', fp: '9', transferable: false, dlc: false, affinity: 'Occult', itemName: 'Ash of War: Spectral Lance', note: 'Thrown spectral spear projectile; Occult affinity' },
  ...
  { skill: 'Square Off', category: 'Stance/Counter', dealsDamage: true, scaling: 'weapon-ar', element: 'physical', fp: '0/6/8', transferable: false, dlc: false, motionValue: 200, affinity: 'Quality', itemName: 'Ash of War: Square Off', note: 'Stance: L=horizontal slash, H=heavy thrust; straight swords' },
  ...
  { skill: 'Storm Blade', category: 'Projectile', dealsDamage: true, scaling: 'weapon-ar', element: 'physical', fp: '10/6', transferable: true, dlc: false, motionValue: 65, affinity: 'Quality', itemName: 'Ash of War: Storm Blade', note: 'Fires vacuum blade projectile; physical wind' },
  { skill: 'Storm Stomp', category: 'AoE', dealsDamage: true, scaling: 'flat', element: 'physical', fp: '6', transferable: true, dlc: false, affinity: 'Quality', itemName: 'Ash of War: Storm Stomp', note: 'Stomp shockwave; AoE around player' },
  { skill: 'Stormcaller', category: 'AoE', dealsDamage: true, scaling: 'weapon-ar', element: 'physical', fp: '9/11', transferable: true, dlc: false, motionValue: 92, affinity: 'Quality', itemName: 'Ash of War: Stormcaller', note: 'Spinning wind cyclone AoE' },
  { skill: 'Swift Slash', category: 'Melee/Burst', dealsDamage: true, scaling: 'weapon-ar', element: 'physical', fp: '16', transferable: false, dlc: true, motionValue: 92, note: 'Quick vacuum slash; Keen; backhand blades only; DLC' },
  { skill: 'The Poison Flower Blooms Twice', category: 'AoE', dealsDamage: true, scaling: 'flat', element: 'physical', fp: '14', transferable: true, dlc: true, status: 'poison', note: 'Poison + rot AoE slam; DLC' },
  ...
  { skill: 'Thunderbolt', category: 'AoE', dealsDamage: true, scaling: 'flat', element: 'lightning', fp: '10/10', transferable: true, dlc: false, affinity: 'Lightning', itemName: 'Ash of War: Thunderbolt', note: 'Calls lightning strike from sky' },
  { skill: 'Transient Moonlight', category: 'Melee/Burst', dealsDamage: true, scaling: 'weapon-ar', element: 'magic', fp: '0/15/20', transferable: false, dlc: false, motionValue: 50, note: 'Stance: L=magic arc, H=long magic wave; unique to Moonveil katana' },
  { skill: 'Unsheathe', category: 'Stance/Counter', dealsDamage: true, scaling: 'weapon-ar', element: 'physical', fp: '0/10/15', transferable: false, dlc: false, motionValue: 190, affinity: 'Keen', itemName: 'Ash of War: Unsheathe', note: 'Iaijutsu stance: L=fast slash, H=heavy slash; katanas only' },
  ...
  { skill: 'Waterfowl Dance', category: 'Melee/Burst', dealsDamage: true, scaling: 'weapon-ar', element: 'physical', fp: '12/9', transferable: false, dlc: false, motionValue: 70, status: 'blood', note: '10-hit flurry; 3 flurry sequences; unique to Hand of Malenia' },
  { skill: 'Waves of Darkness', category: 'AoE', dealsDamage: true, scaling: 'weapon-ar', element: 'magic', fp: '16/5', transferable: false, dlc: false, motionValue: 100, affinity: 'Magic', itemName: 'Ash of War: Waves of Darkness', note: 'Magic wave AoE burst; colossal swords' },
  ...
  { skill: 'Wild Strikes', category: 'Melee/Burst', dealsDamage: true, scaling: 'weapon-ar', element: 'physical', fp: '2/10/15', transferable: true, dlc: false, motionValue: 107, affinity: 'Heavy', itemName: 'Ash of War: Wild Strikes', note: 'Rapid 6-hit rampage; low per-hit MV but fast' },
  { skill: 'Wing Stance', category: 'Stance/Counter', dealsDamage: true, scaling: 'weapon-ar', element: 'physical', fp: '0/8/10', transferable: false, dlc: true, motionValue: 83, note: 'Stance L=slash H=sweep; Quality; light greatswords only; DLC' },
]
